...
public class InitDatabaseDialog extends JDialog {
  private final static Logger logger = LogManager.getLogger(InitDatabaseDialog.class);
  ...
  public static void main(String[] args) {
    InitDatabaseDialog dialog = new InitDatabaseDialog(null);
    dialog.pack();
  ...
  public InitDatabaseDialog() {

  }

  public InitDatabaseDialog(Frame tparentDlg) {

    super(tparentDlg);
    parentDlg = tparentDlg;

    if (tparentDlg != null) {
      pm = new GraphicMonitor(tparentDlg, "runing...", "progress", 0, 100);
    } else {
      pm = new GraphicMonitor(tparentDlg, "runing...", "progress", 0, 100);
    }
    ...
    loadFears.addActionListener(new LoadFAERSActionZIP(parentDlg));
    ...
    buildTableRun.addActionListener(new CalculatObserCountExpectCount());
    loadIntoDatabasePanel.add(new JSeparator());
    ...
    calculate.addActionListener(new CalculateEbgmLfdr(this));
