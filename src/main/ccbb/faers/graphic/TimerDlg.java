...
public class TimerDlg extends JDialog {

  private static final long serialVersionUID = 1L;

  final static Logger logger = LogManager.getLogger(TimerDlg.class);
  ...
  public TimerDlg(String information) {

    logger.info("timer dialog");

    final TimerDlg dialog = this;
